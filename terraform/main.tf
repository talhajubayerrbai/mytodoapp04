...
resource "aws_db_instance" "main" {
  ...
  # Skip the final snapshot on destroy. Using a fixed snapshot identifier
  # (skip_final_snapshot = false) causes a DBSnapshotAlreadyExists error on
  # every destroy after the first because AWS won't overwrite an existing
